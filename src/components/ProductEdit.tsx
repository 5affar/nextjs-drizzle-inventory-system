...
export default function ProductEdit({ onClose, onSuccess, product }: ProductEditProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const validationResult = UpdateProductSchema.safeParse(formValues);
      ...
      <div className="bg-white p-6 rounded-xl shadow-lg flex flex-col w-96">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex gap-3 justify-end pt-4 border-t">
            ...
            {loading ? (
              <LoadingButton text="Updating..." type="submit" />
            ) : (
              <PrimaryButton name="Update Product" type="submit" />
            )}
          </div>
        </form>
      </div>
